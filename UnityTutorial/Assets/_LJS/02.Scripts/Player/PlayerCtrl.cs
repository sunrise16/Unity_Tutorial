...
// 클래스는 System.Serializable 이라는 어트리뷰트(Attribute)를 명시해야 Inspector 뷰에 노출됨
[System.Serializable]
...
public class PlayerCtrl : MonoBehaviour
{
    ...
    void Update()
    {
        // ※ Update 함수에서 접근해야 할 컴포넌트는 Awake 함수나 Start 함수에서 미리 변수에 할당한 후에 사용할 것!
        ...
        tr.Rotate(Vector3.up * r * rotateSpeed * Time.deltaTime, Space.Self);
